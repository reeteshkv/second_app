...
class DirectoriesControllerTest < ActionController::TestCase
  ...
  test "should create directory" do
    assert_difference('Directory.count') do
      post :create, directory: { friend: @directory.friend, name: @directory.name, phonenumber: @directory.phonenumber }
    end
  ...
  test "should update directory" do
    put :update, id: @directory, directory: { friend: @directory.friend, name: @directory.name, phonenumber: @directory.phonenumber }
    assert_redirected_to directory_path(assigns(:directory))
  end
